...
const SignPage = () => {
  ...
  const [securityGate, setSecurityGate] = useState(true); // Blocks view until unlocked
  ...
  const handleSignSubmit = async () => {
    ...
    try {
      await axios.post(`${API_BASE}/esign/seal`, { workflowId, signerId, fieldsData, termsAccepted, password: authPassword });
